...
class StoryBrain {
  ...
  String getStory(int storyNumber){
    if(_storyData.length<storyNumber){
      return 'Invalid Story Number.';
    }
    return _storyData[storyNumber-1].storyTitle;
  }
  String getChoice1(int storyNumber){
    if(_storyData.length<storyNumber){
      return 'Invalid Story Number.';
    }
    return _storyData[storyNumber-1].choice1;
  }
  String getChoice2(int storyNumber){
    if(_storyData.length<storyNumber){
      return 'Invalid Story Number.';
    }
    return _storyData[storyNumber-1].choice2;
  }
